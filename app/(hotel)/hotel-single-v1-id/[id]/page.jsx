...
import Header2 from "@/components/header/header-2-id";
...
import AvailableRooms from "@/components/hotel-single/AvailableRoomsEn";
...
import Hotels2 from "@/components/hotels/Hotels2En";
import CallToActions from "@/components/common/CallToActions";
import DefaultFooter from "@/components/footer/default-id";
import GalleryOne from "@/components/hotel-single/GalleryOneEn";
    ...
    <>
        ...
        <div className="container">
          <div className="row pb-20">
            <div className="col-auto">
              <h3 className="text-22 fw-500">Paket Tersedia</h3>
            </div>
          </div>
          {/* End .row */}
      ...
      <section className="pt-40" id="reviews">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="text-22 fw-500">Ulasan Tamu</h3>
            </div>
          </div>
          {/* End .row */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-8 col-lg-10">
              <div className="row">
                <div className="col-auto">
                  <h3 className="text-22 fw-500">Kirim Balasan</h3>
            ...
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">
                  Site Terbang Tendem Terdekat Lainnya
                </h2>
