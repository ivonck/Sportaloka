            ...
            <div className="row x-gap-20 y-gap-20">
              ...
              <div className="col-md">
                ...
                <h3 className="text-18 lh-16 fw-500">
                  {item?.titleId} <br />
                  <p className="text-14 lh-14 mt-5">{item?.descriptionId}</p>
                </h3>
              ...
              <div className="col-md-auto text-right md:text-left">
                ...
                <div className="text-14 text-light-1 mt-5">Tamu Lokal</div>
                <div className="text-20 lh-12 fw-600 mt-5">
                  Rp. {item?.price}
                </div>
                <div className="text-14 text-light-1 mt-5">Tamu Mancanegara</div>
                ...
                >
                  Pesan Sekarang<div className="icon-arrow-top-right ml-15"></div>
                </Link>
              </div>
              {/* End col-md */}
            </div>
