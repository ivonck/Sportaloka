            ...
            <div className="row x-gap-20 y-gap-20">
              ...
              <div className="col-md">
                ...
                <h3 className="text-18 lh-16 fw-500">
                  ...
                  <p className="text-14 lh-14 mt-5">{item?.operatorDescription}</p>
                </h3>
                ...
                <div className="text-14 text-green-2 fw-500 lh-15 mt-5">
                  WIFI - Toilet - Shuttle from Landing to Takeoff - Friendly English Speaking Pilot
                </div>
              </div>
              {/* End col-md */}
              ...
              <div className="col-md-auto text-right md:text-left">
                ...
                >
                  View Details <div className="icon-arrow-top-right ml-15"></div>
                </Link>
              </div>
              {/* End col-md */}
            </div>
